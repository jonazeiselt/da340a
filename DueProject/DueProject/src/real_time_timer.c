...
uint32_t realTimeValue = 0; //definition of external variable, declared in h-file

//declare static, don't declare in header-file since access to static functions is restricted to the file where they are declared.
